...
<form className='h-36 bg-black px-8 py-6'>   
    ...
    <div class="relative">
        ...
        <input type="search" id="default-search" class="block w-full p-3 pl-10 text-sm text-gray-900 rounded-lg bg-gray-50 focus:outline-none" placeholder="Search Projects, Freelancers..." required />
