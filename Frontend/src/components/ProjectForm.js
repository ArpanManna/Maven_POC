...
const ProjectForm = () => {
    ...
    return (
        <form className='my-2'>
            <input id="projectName" name="projectName" value={projectName} onChange={handleFormChange} type="text" required="" maxLength="100" placeholder="Choose a name for your project" className="block w-full px-5 py-3 text-mono text-gray-800 font-bold placeholder-gray-400 placeholder:font-bold transition duration-500 ease-in-out transform border border-transparent rounded-lg bg-gray-100 focus:outline-none focus:border-transparent focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-300" />
            ...
            <div className="relative mt-3">
                ...
                <br />
                <DatePicker onChange={handleDeadlineChange} className='border-gray-600 mt-2' />
            </div>
            <div className="relative mt-3">
