                    ...
                    <div className="">
                        <div className="px-7 mb-8">
                            ...
                            <div className='flex flex-wrap gap-2 sm:gap-4'>
                                <h2 className="text-3xl font-bold text-palatte4 ">Beth J. Greene</h2>
                                <h2 className="text-sm font-semibold mt-3 text-palatte2 ">0xa67...994</h2>

                            </div>
                            <p className="text-palatte5 mt-2">Blockchain Developer</p>
